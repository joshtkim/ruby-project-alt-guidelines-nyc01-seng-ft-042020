class CommandLineInterface
    ...
    def run
        ...
        while input = gets.chomp.to_i
            ...
            when 4
                ...
                break
            when 5
                puts "Thank you! Have a nice day and come back soon!".green.on_white, ""
                break
            else
    ...
    def ret_writer_start
        ...
        if Writer.find_by(name: writer_input)
            puts "", "Welcome #{writer_input}!".black.on_white
    ...
    def new_webtoon_confirm(writer_input)
        line_break
        puts "Hello! Please confirm that you would like to create a new Webtoon!".red.on_white, ""
        print "y/n: "
    ...
    def writer_new_webtoon(writer_input)
        line_break
        puts "Congratulations on a new Webtoon. Could you please provide the title and release day of the Webtoon?".green, ""
        print "Title: "
        ...
        puts "", "Congratulations on your new Webtoon #{title_input.titleize} that releases weekly on #{release_input.capitalize}!".magenta.on_white
        writer_options(writer_input)
    end
    ...
    def writer_del_webtoon(writer_input)
        line_break
        puts "Could you please advise which Webtoon you will no longer write?".green, ""
        print "Title: "
        title_input = gets.chomp.downcase
        if x = Webtoon.find_by(title: title_input)
            x.delete
            puts "", "You have successfully removed #{title_input.titleize}.".magenta.on_white
            writer_options(writer_input)
        else
    ...
    def webtoon_day_confirm(writer_input)
        line_break
        puts "Hello! Please confirm that you would like to change the release day of your Webtoon!".red.on_white, ""
        print "y/n: "
        valid_input = gets.chomp.downcase
        if valid_input == "y"
    ...
    def writer_day_webtoon(writer_input)
        line_break
        puts "Could you please advise which Webtoon you would like to update the release day for and the new release day?".green, ""
        print "Title: "
        title_input = gets.chomp.downcase
        print "Release Day(Monday-Saturday): "
        ...
        puts "", "Congratulations! Your Webtoon #{title_input.titleize} has a new release day on #{day_input.capitalize}!".magenta.on_white
        writer_options(writer_input)
    end
    ...
    def new_writer_confirm
        line_break
        puts "Hello! Please confirm that you are a new writer and would like to create a new profile!".red.on_white, ""
        print "y/n: "
        valid_input = gets.chomp.downcase
        if valid_input == "y"
            new_writer_start
    ...
    def new_writer_start
        title_break
        puts "Hello Writer! Please tell us your name and years of experience so we can create a profile for you.".green, ""
        print "Name: "
        ...
        puts "", "Congratulations #{name_input} on joining our Webtoon Writer family!".magenta.on_white
    ...
    def ret_reader_start
        title_break
        puts "Hello Reader! Please tell us your name so we can assist you accordingly!".blue.on_white,""
        print "Please enter your name: "
        reader_input = gets.chomp.titleize
        if Reader.find_by(name: reader_input)
            puts "", "Welcome #{reader_input}!".black.on_white
    ...
    def reader_options(reader_input)
        title_break
        puts "Please select from the options listed".blue.on_white, "", "1) Find all Webtoons I am reading", "2) Find the Writer of your favorite Webtoon", "3) Exit", ""
        print "Please select the corresponding number: "
        while input = gets.chomp.to_i
            case input
            when 1
    ...
    def reader_writer(reader_input)
        line_break
        puts "Please provide the title of your favorite Webtoon!".blue.on_white, ""
        print "Webtoon title: "
        title_input = gets.chomp.downcase
        x = Webtoon.find_by(title: title_input)
        y = x.writer_id
        ...
        z.name
        puts "", "Your favorite Webtoon's writer is #{z.name}!".magenta.on_white
        reader_options(reader_input)
    end
    ...
    def new_reader_confirm
        line_break
        puts "Hello! Please confirm that you are a new reader and would like to create a new profile!".red.on_white, ""
        print "y/n: "
        valid_input = gets.chomp.downcase
        if valid_input == "y"
            new_reader_start
    ...
    def new_reader_start
        title_break
        puts "Hello Reader! Please tell us your name and age so we can create a profile for you.".green, ""
        print "Name: "
        name_input = gets.chomp.titleize
        print "Age: "
        age_input = gets.chomp.to_i
        Reader.create(name: name_input, age: age_input)
        puts "", "Congratulations #{name_input} on joining our Webtoon Reader family!".magenta.on_white
        reader_options(name_input)
    end

    def user_exit
        puts "", "Thank you! We will return you back to the main menu!".magenta.on_white
        run
    end
